...
![group-by-key-wordcount](https://Fainer.github.io/assets/images/sparktuning/group-by-key-wordcount.jpg)
reduceByKey实现wordcount原理
![reduce-by-key-wordcount](https://Fainer.github.io/assets/images/sparktuning/reduce-by-key-wordcount.jpg)
### 原则六：使用高性能的算子
...
### Spark基本运行原理
![spark-base-mech](https://Fainer.github.io/assets/images/sparktuning/spark-base-mech.jpg)
